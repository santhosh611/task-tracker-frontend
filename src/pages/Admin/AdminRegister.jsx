        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="form-group">
            ...
            <p className='text-ls text-gray-500 my-2'>
              https://{formData.subdomain}.task-tracker-frontend-omega.vercel.app/ {formData.subdomain !== "" ? (domainAvailable ? <span className='text-green-600'>*Available</span> : <span className='text-red-600'>*Not Available</span>) : null}
            </p>
          </div>
